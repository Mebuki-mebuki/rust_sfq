module HalfAdder (a, b, clk, c, s, __cycle);
...
rustsfq_split SPLIT1 (clk, _SPLIT1_q1, _SPLIT1_q2, __cycle);
rustsfq_split SPLIT2 (a, _SPLIT2_q1, _SPLIT2_q2, __cycle);
rustsfq_split SPLIT3 (b, _SPLIT3_q1, _SPLIT3_q2, __cycle);
...
rustsfq_split SPLIT1 (clk, _SPLIT1_q1, _SPLIT1_q2, __cycle);
rustsfq_split SPLIT2 (_SPLIT1_q1, _SPLIT2_q1, _SPLIT2_q2, __cycle);
HalfAdder HalfAdder3 (a, b, _SPLIT1_q2, _HalfAdder3_c, _HalfAdder3_s, __cycle);
rustsfq_dff DFF4 (cin_d1, _SPLIT2_q2, _DFF4_q, __cycle);
rustsfq_split SPLIT5 (_SPLIT2_q1, _SPLIT5_q1, _SPLIT5_q2, __cycle);
rustsfq_buff BUFF6 (_HalfAdder3_c, _BUFF6_q, __cycle);
rustsfq_buff BUFF7 (_BUFF6_q, _BUFF7_q, __cycle);
rustsfq_dff DFF8 (_BUFF7_q_d1, _SPLIT5_q1, _DFF8_q, __cycle);
rustsfq_buff BUFF9 (_HalfAdder3_s, _BUFF9_q, __cycle);
rustsfq_buff BUFF10 (_BUFF9_q, _BUFF10_q, __cycle);
rustsfq_buff BUFF11 (_DFF4_q, _BUFF11_q, __cycle);
